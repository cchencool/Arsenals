 ...
 */
public class UDAF_Union extends AbstractGenericUDAFResolver {

    static final Log LOG = LogFactory.getLog(UDAF_Union.class.getName());
...
//        }
        ...
        return new Union_Evaluator();
    }


    public static class Union_Evaluator extends GenericUDAFEvaluator {
...
//                merge(agg, parameters[0]);
        ...
        public Object terminatePartial(AggregationBuffer agg) throws HiveException {
            ...
            ((AggBuffer) agg).resultDouble = ((AggBuffer) agg).values.stream().reduce((a, b) -> ((a != 0) || (b != 0)) ? 1.0 : 0.0).orElseGet(() -> 0.0);
        ...
        public void merge(AggregationBuffer agg, Object partial) throws HiveException {
            ...
            if (partial != null) {
                double a = ((AggBuffer) agg).resultDouble;
                double b = PrimitiveObjectInspectorUtils.getDouble(partial, P1OI);

                ((AggBuffer) agg).resultDouble = ((a != 0) || (b != 0)) ? 1.0 : 0.0;
            }
